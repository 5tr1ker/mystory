                        ...
                        <div className="profile-data">
                            {profileEdits ?
                                <div className="profile-editmode">
                                    <span>Name  : </span><input type="text" placeholder="name" maxLength={20} defaultValue={inputProfileData.userId} onChange={changeGetData} name="userId"/><br/>
                                    <span>Email : </span><input type="text" placeholder="Email" defaultValue={profileData.email} disabled={true} name="email"/><br/>
                                    <span>Phone : </span><input type="text" placeholder="Phone" maxLength={15} defaultValue={profileData.phone} onChange={changeGetData} name="phone"/><br/>
