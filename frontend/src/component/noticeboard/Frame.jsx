...
const NoticeFrame = () => {
    ...
    const [todoDrop , setTodoDrop] = useState(false);
    ...
    const setTodoDropTool = () => {
        setDropBox(false);
        todoDrop ? setTodoDrop(false) : setTodoDrop(true);
    }
            ...
            <div className="noticeFrame">
                <header className="noticeFrameHeader">
                    ...
                    <div id="buttonArea">
                        ...
                        {todoDrop ? <Todo dropDownSet={setTodoDropTool}/> : null}
